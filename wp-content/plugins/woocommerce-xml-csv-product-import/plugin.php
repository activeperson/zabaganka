    ...
    final class PMWI_Plugin {
        ...
        public function plugin_row_meta($links, $file){
            if ( $file == plugin_basename( __FILE__ ) ) {
                $row_meta = array(
                    'pro'    => '<a href="http://www.wpallimport.com/woocommerce-product-import/" target="_blank" title="' . esc_attr( __( 'WP All Import - WooCommerce Add-On Pro Version', self::TEXT_DOMAIN ) ) . '">' . __( 'Pro Version', self::TEXT_DOMAIN ) . '</a>',
                );
